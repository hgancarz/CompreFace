...
import com.exadel.frs.commonservice.sdk.embedding.service.EmbeddingRestApiClient;
...
public class EmbeddingCalculatorHealthIndicator implements HealthIndicator {
    ...
    private final EmbeddingRestApiClient embeddingRestApiClient;

    public EmbeddingCalculatorHealthIndicator(EmbeddingRestApiClient embeddingRestApiClient) {
        this.embeddingRestApiClient = embeddingRestApiClient;
    }

    @Override
    public Health health() {
        try {
            embeddingRestApiClient.health();
