...
public enum ExceptionCode {
    ...
    NAME_IS_NOT_UNIQUE(18, BAD_REQUEST),
    APP_DOES_NOT_BELONG_TO_ORG(19, BAD_REQUEST),
    USER_ALREADY_HAS_ACCESS_TO_APP(20, BAD_REQUEST),
    USER_ALREADY_IN_ORG(21, BAD_REQUEST),
    UNAVAILABLE_FILE_EXTENSION(22, BAD_REQUEST),
